...
@OutboundConnector(name = "KeycloakFunction", inputVariables = { KeycloakInput.INPUT_KEYCLOAK_FUNCTION,
    KeycloakInput.INPUT_SERVER_URL, KeycloakInput.INPUT_REALM,
    KeycloakInput.INPUT_ADMIN_CLIENT_ID, KeycloakInput.INPUT_ADMIN_USER_NAME, KeycloakInput.INPUT_ADMIN_PASSWORD,
    KeycloakInput.INPUT_USER_NAME, KeycloakInput.INPUT_USER_FIRSTNAME, KeycloakInput.INPUT_USER_LASTNAME,
    KeycloakInput.INPUT_USER_EMAIL, KeycloakInput.INPUT_USER_PASSWORD,
    KeycloakInput.INPUT_USER_ID, KeycloakInput.INPUT_PAGE_NUMBER, KeycloakInput.INPUT_PAGE_SIZE
}, type = "c-keyclaok-function")
  ...
  public KeycloakOutput execute(OutboundConnectorContext outboundConnectorContext) throws Exception {
    ...
    for (KeycloakSubFunction inputSubFunction : getListSubFunctions()) {
      if (inputSubFunction.getSubFunctionType().equals(function)) {
        KeycloakOutput pdfOutput = inputSubFunction.executeSubFunction(keycloakInput, outboundConnectorContext);
        logger.info("KeycloakFunction End function [{}] in {} ms", function, System.currentTimeMillis() - beginTime);
        return pdfOutput;
      }
    }
    throw new ConnectorException(ERROR_UNKNOWN_FUNCTION, "Keyclaok Function Unknown [" + function + "]");
  }

  @Override
  public String getDescription() {
    return "Keyclaok operation (add/remove user";
  }
