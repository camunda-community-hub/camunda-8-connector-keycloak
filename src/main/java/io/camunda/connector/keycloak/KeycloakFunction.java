...
public class KeycloakFunction implements OutboundConnectorFunction, CherryConnector {
  ...
  public final static String ERROR_CREATE_USER_LABEL = "Fail to create a user";
  public final static String ERROR_REMOVE_USER = "REMOVE_USER";
  public final static String ERROR_REMOVE_USER_LABEL = "Fail to remove a user";
  public final static String ERROR_SEARCH_USER = "SEARCH_USER";
  public final static String ERROR_SEARCH_USER_LABEL = "Fail to search a user";
  public final static String ERROR_KEYCLOAK_CONNECTION = "KEYCLOAK_CONNECTION";
  public final static String EERROR_KEYCLOAK_CONNECTION_LABEL = "Error arrived during the Keycloak connection";
  ...
  public static final List<Class<?>> allFunctions = Arrays.asList(AddUserFunction.class, RemoveUserFunction.class,
      SearchUserFunction.class);
  ...
  private List<KeycloakSubFunction> getListSubFunctions() {
