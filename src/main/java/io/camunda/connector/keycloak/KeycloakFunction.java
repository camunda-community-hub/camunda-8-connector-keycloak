...
import io.camunda.connector.keycloak.user.CreateUserFunction;
import io.camunda.connector.keycloak.user.DeleteUserFunction;
import io.camunda.connector.keycloak.user.SearchUserFunction;
import io.camunda.connector.keycloak.user.UpdateUserFunction;
...
@OutboundConnector(name = "KeycloakFunction", inputVariables = { KeycloakInput.INPUT_KEYCLOAK_FUNCTION,
    ...
    KeycloakInput.INPUT_USER_NAME, // addUser/SearchUser
    KeycloakInput.INPUT_USER_FIRSTNAME, // addUser/SearchUser
    KeycloakInput.INPUT_USER_LASTNAME, // addUser/SearchUser
    KeycloakInput.INPUT_USER_EMAIL, // addUser/SearchUser
    ...
    KeycloakInput.INPUT_PAGE_NUMBER,
...
public class KeycloakFunction implements OutboundConnectorFunction, CherryConnector {
  ...
  public KeycloakOutput execute(OutboundConnectorContext outboundConnectorContext) throws Exception {
    ...
    if (KeycloakInput.INPUT_CONNECTION_TYPE_V_USER.equals(keycloakInput.getConnectionType())
  ...
  } else if (KeycloakInput.INPUT_CONNECTION_TYPE_V_KEYCLOAK_CONNECTION_URL.equals(keycloakInput.getConnectionType())) {
      ...
      +KeycloakInput.INPUT_CONNECTION_TYPE_V_USER+"|"+KeycloakInput.INPUT_CONNECTION_TYPE_V_CLIENT_ID+"|"+KeycloakInput.INPUT_CONNECTION_TYPE_V_KEYCLOAK_CONNECTION_URL+"]");
  }
    long endKeycloakConnectionTime = System.currentTimeMillis();

    if (endKeycloakConnectionTime - beginTime > 500)
      logger.info("KeycloakFunction receive function [{}]  to Keycloack server {} in {} ms", function, keycloakOperation.getKeycloakSignature(),
